...
const MotorController = {
   ...
   index: async(req,res) => {
    ...
    // const {siglae_corrigida} = req.body;
    // const classificacao = 'COMLURB'
    ...
    const buscaConvenio = `select * from tabela_comissao where convenio = '${convenio}'`
    ...
    if(consulta1.length > 0){
        ...
        if(conv){
            ...
            var clas = {'classificacao':conv.classificacao_convenio}
        }
        else{

           var clas = {'classificacao':"Padrao"}
        }
