const {tbl_usuario, usuario_mes2, setor_usuario2, usuario_dia2} = require('../models');
...
const TblUsuarioController = {
    ...
    Filtro: async (req, res) => {
        ...
        try {
            ...
            (pesquisaSetor.length > 0 || pesquisaMes.length > 0 || pesquisaDia.length > 0) ? res.json({pesquisaSetor, pesquisaMes, pesquisaDia}) : res.json({message: "Não há registros com esse filtro"});
