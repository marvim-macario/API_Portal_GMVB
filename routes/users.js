...
const RelatorioPendenciasController = require('../controllers/RelatorioPendenciasControllers');
...
router.get('/pendencia/usuario', RelatorioPendenciasController.Usuario);
