module.exports = (sequelize, DataTypes) => {
    const base_parceiros = sequelize.define('base_parceiros', {
        id_parceiro: {
        ...
        quat_crefisa:DataTypes.STRING, 
        pct_quat_crefisa:DataTypes.STRING, 
        ajuda_custo:DataTypes.STRING,
    }, {
        tableName: 'banco_parceiros',
        timestamps: false
    })

    base_parceiros.associate = function(models) {
        base_parceiros.belongsTo(models.parceiro2, {foreignKey: 'cpf'})
        };
    return base_parceiros;
};