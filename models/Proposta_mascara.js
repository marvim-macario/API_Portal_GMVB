...
module.exports = (sequelize, DataTypes) => {
    const proposta_mascara = sequelize.define('proposta_mascara', {
        codigo: {
        ...
        documento_tipo:DataTypes.STRING, 
        ...
        acao_comercial:DataTypes.STRING, 
        acao_comercial_1:DataTypes.STRING, 
        acao_comercial_2:DataTypes.STRING, 
        valor_patrimonio_resumindo:DataTypes.STRING, 
        cep_comercial:DataTypes.STRING, 
        endereco_logradouro_comercial:DataTypes.STRING, 
        endereco_numero_comercial:DataTypes.STRING, 
        endereco_complemento_comercial:DataTypes.STRING, 
        endereco_uf_comercial:DataTypes.STRING, 
        endereco_municipio_comercial:DataTypes.STRING, 
        endereco_bairro_comercial:DataTypes.STRING, 
        telefone_classe_1:DataTypes.STRING, 
        telefone_ramal_1:DataTypes.STRING, 
        telefone_classe_2:DataTypes.STRING, 
        telefone_ddd_2:DataTypes.STRING, 
        telefone_numero_2:DataTypes.STRING, 
        telefone_ramal_2:DataTypes.STRING, 
        telefone_classe_3:DataTypes.STRING, 
        telefone_tipo_3:DataTypes.STRING, 
        telefone_ddd_3:DataTypes.STRING, 
        telefone_numero_3:DataTypes.STRING, 
        telefone_ramal_3:DataTypes.STRING, 
        beneficio_cartao:DataTypes.STRING, 
        taxa:DataTypes.STRING, 
        taxaespecial:DataTypes.STRING, 
        codigo_validacao:DataTypes.STRING, 
        defesa_taxa:DataTypes.STRING, 
        valor_patrimonio_resumido:DataTypes.STRING, 
        telefone_tipo_2:DataTypes.STRING, 
        ...
        valor_seguro: DataTypes.INTEGER,
        ip:DataTypes.STRING, 
        cidade_ip:DataTypes.STRING,
        estado_ip:DataTypes.STRING ,
        pais_ip:DataTypes.STRING, 
        taxa_anual:DataTypes.STRING,
    }, {
        tableName: 'proposta_mascara',
        timestamps: false
    })
    return proposta_mascara;
};
